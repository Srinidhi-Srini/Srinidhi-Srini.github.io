...
---
## Introduction
The impulse response. This is something I learned in my Systems and Signals class, but I really think it's fascinating enough to get it's own blog post. 
...
To get the impulse response, we need to give it some input. This input is what we call the impulse signal or the IMPULSE. In math, we call it the Dirac Delta function, written as $$\delta(t)$$. The Diract Delta is defined as:
...
It can be of any width or length, but I like to think of it using the above representation. Physically, the perfect impulse is not possible, but we can come very close to it. There are many practical approximations that work great for most real systems.
