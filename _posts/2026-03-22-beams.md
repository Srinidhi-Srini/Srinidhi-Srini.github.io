...
## Example
It's hard to still understand it through just reading it, so I will do a super simple example. I'm not going to do method 1 since it's pretty straightforward (yet time consuming sometiems), and method 2 is the much easier and better method. 
